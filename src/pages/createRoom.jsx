      ...
      <div className="grid grid-cols-2 gap-8 px-40 py-60 items-center">
        <div>
          ...
          <Link href="/" className="inline-flex items-stretch">
            <button className="bg-transparent hover:bg-white text-gray-100 border border-white font-bold mt-9 py-5 px-4 rounded inline-flex items-center">
              <svg
              ...
              <span className=" font-normal ">Return to Home</span>
            </button>
          </Link>
        </div>
        <div>
